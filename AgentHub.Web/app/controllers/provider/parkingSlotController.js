(function() {
    "use strict";
    angular.module("app").controller("providerParkingSlotController", function ($scope, $timeout, $location, $anchorScroll, baseService, userService, googleMapService, providerService, uiGmapGoogleMapApi, $mdDialog) {
        $scope.slotProviders = [];
        $scope.providers = [];
        ...
        $scope.imageChanged = function (fileInput, imageIndex) {
            ...
            //        if (imageIndex === 0)
            //            slotProvider.Base64Image1 = e.target.result;
            //        else if (imageIndex === 1)
            //            slotProvider.Base64Image2 = e.target.result;
            //        else if (imageIndex === 2)
            //            slotProvider.Base64Image3 = e.target.result;
