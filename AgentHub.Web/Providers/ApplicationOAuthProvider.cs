...
namespace AgentHub.Web.Providers
{
    /// <summary>
    ...
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            //
            // User this line to get all data posted from client
            //var dataPosted = await context.Request.ReadFormAsync();

            var user = await userManager.FindAsync(context.UserName, context.Password);

            if (user == null)
            {
                context.SetError("invalid_grant", StringTable.IncorrectUsernamePassword);
                return;
            }
            // 
        ...
        /// <summary>
        /// Creates the authentication's properties.
        /// </summary>
        /// <param name="userName">Name of the user.</param>
        /// <returns>
        /// Authentication properties created.
        /// </returns>
